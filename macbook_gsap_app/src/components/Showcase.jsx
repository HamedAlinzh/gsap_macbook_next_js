    ...
    return (
        <section id="showcase">
            <div className="media">
                ...
                <div className="mask">
                    <img src="/mask-logo.svg" />  {/* svg is super easy to show on top of other elements */}
                </div>
            </div>

            <div className="content">
                <div className="wrapper">
                    <div className="lg:max-w-md"> {/*stay in the middle on large devices */}
                        <h2>Rocket Chip</h2>
                        ...
                        <div className="space-y-5 mt-7 pe-10">
                            <p>
                                ...
                                <span className="text-white">
                                    M4, the next generation of Apple silicon ajab chizie!
                                </span>
                                . M4 powers
                            </p>
                            <p>
